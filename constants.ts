...
export const TRANSLATIONS = {
  en: {
    ...
    castle: 'Castle',
    rank: 'Rank',
    confirmReset: 'Are you sure you want to start a new game? All 3 epochs will be cleared.',
    boardResetLog: 'New game started. All epochs cleared.',
    selected: 'Selected',
    eraser: 'Eraser',
    tilesTitle: 'Tiles',
  ...
  ja: {
    ...
    castle: '城',
    rank: 'ランク',
    confirmReset: '新しいゲームを開始しますか？ 全3ラウンドの盤面が消去されます。',
    boardResetLog: '新しいゲームを開始しました。',
    selected: '選択中',
    eraser: '消しゴム',
    tilesTitle: 'タイル',
    castlesTitle: '城',
